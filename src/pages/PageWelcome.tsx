	...
	return (
		<section className="page pageWelcome">
			...
			<ul className="list-disc ml-6">
				<li><span className="font-semibold">notes</span> are here: <a href="https://tanguay-eu.vercel.app/forays/321" target="_blank" className="underline">https://tanguay-eu.vercel.app/forays/321</a></li>
				<li><span className="font-semibold">repo</span> is here: <a href="https://github.com/edwardtanguay/newtech2024" target="_blank" className="underline">https://github.com/edwardtanguay/newtech2024</a></li>
				<li><span className="font-semibold">online site</span> is here: <a href="https://newtech2024.vercel.app" target="_blank" className="underline">https://newtech2024.vercel.app</a></li>
